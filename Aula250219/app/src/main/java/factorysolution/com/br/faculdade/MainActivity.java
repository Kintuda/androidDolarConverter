...
//    private ViewHolder viewHolder = new ViewHol();
    ...
    public void onClick(View view) {
        ...
        Toast.makeText(this, view.getId(),100).show();
        if (view.getId() == R.id.btn_calcular) {
            Toast.makeText(this, "Digita alguma coisa ai!",100).show();
            // Obtém o valor do EditText
//            Toast.makeText(android.R.attr.contextClickable this,)
            ...
            if(this.editReal.getText().length() >  1 || this.editEuro.getText().length() > 1|| this.editDolar.getText().length() > 1){
                ...
                Toast.makeText(this, "É necessário preencher todos os campos!",100).show();
            }
        }
        else if(view.getId() == R.id.btn_clear){
            Toast.makeText(this, "Limpo!",100).show();
            this.clearValues();
        }
    }
